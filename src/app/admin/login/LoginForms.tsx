...
import { login, requestPasswordReset, updatePassword, type AuthFormState } from "../actions";
...
export function LoginForm({ next, initialEmail }: { next: string; initialEmail?: string }) {
  ...
  if (mode === "reset") {
    return (
      <div>
        ...
        <h1 className="text-xl font-semibold">Recuperá tu contraseña</h1>
        ...
        {resetState?.ok ? (
          ...
          <form action={resetAction} className="mt-6 space-y-4">
            ...
            <Button type="submit" variant="primary" size="lg" loading={resetPending} className="w-full">
              Enviar link
            </Button>
          </form>
        )}
  ...
  return (
    <div>
      <h1 className="text-xl font-semibold">Ingresá al panel</h1>
      ...
      <form action={loginAction} className="mt-6 space-y-4">
        ...
        <Button type="submit" variant="primary" size="lg" loading={loginPending} className="w-full">
          Ingresar
        </Button>
      </form>
    </div>
